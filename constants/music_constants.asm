...
const_value = 1
	...
	; custom for old channel replacement methods
	const MUSIC_FAREWELL_RIVAL
	const MUSIC_MEET_RIVAL_ALT_TEMPO
	const MUSIC_FAREWELL_RIVAL_ALT_TEMPO
	const MUSIC_CITIES1_ALT_TEMPO
	
LAST_MUSIC EQU const_value ; used to setup the transposition array in crysaudio/engine.asm

; crysaudio sfx (cries are now separate)
const_value = 1
    ; old (mostly) universal. get_item_1 is overriden by level_up in audio2
